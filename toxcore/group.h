 ...
 *
 *  Function(Group_Chats *g_c, uint32_t group_number, uint32_t friendgroup_number, uint8_t * message, uint16_t length, void *userdata)
 */
 ...
 *
 * Function(Group_Chats *g_c, uint32_t group_number, uint32_t friendgroup_number, uint8_t * title, uint8_t length, void *userdata)
 ...
 * return -2 if peernumber is invalid.
 */
int group_peername_size(const Group_Chats *g_c, uint32_t group_number, int32_t peernumber);
 ...
 *
 * Function(void *group object (set with group_set_object), uint32_t group_number)
 *
 * return 0 on success.
 * return -1 on failure.
 */
